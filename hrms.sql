...
CREATE TABLE public.employee_confirms_to_employers
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
...
(
    ...
    web_address character varying(25) NOT NULL,
    phone_number character varying(12) NOT NULL,
    company_email character varying(25) NOT NULL,
...
ALTER TABLE public.employee_confirms
    ADD FOREIGN KEY (id)
    REFERENCES public.employee_confirms_to_employers (id)
    NOT VALID;
